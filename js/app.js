...
const palettes = [
    {bg:"#111", card:"#1b1b1b", text:"#fff", accent:"#6c5ce7"},
    {bg:"#1a0f1f", card:"#241327", text:"#fff", accent:"#d13cff"},
    {bg:"#0f1a17", card:"#132421", text:"#e8fff7", accent:"#00c896"},
    {bg:"#1b1e29", card:"#232633", text:"#ffffff", accent:"#4d7cff"},
    {bg:"#1d1616", card:"#241b1b", text:"#ffeaea", accent:"#ff6b6b"},
    {bg:"#101820", card:"#18222c", text:"#e3eef8", accent:"#00aaff"},
];
